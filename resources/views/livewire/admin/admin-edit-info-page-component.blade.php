                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form wire:submit.prevent="updateInfoPage">
                                    <div class="mb-3 mt-3">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="file" class="form-control" name="newImage" placeholder="Choose an Image" wire:model="newImage">
                                        @if($newImage)
                                            <img src="{{ $newImage->temporaryUrl() }}" width="120">
                                        @else
                                            <img src="{{ asset('assets/imgs/info-pages') }}/{{ $image }}" width="120">
                                        @endif
                                        @error('newImage')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    ...
                                    @if($info_page_template_component_name == 'one-column-info-page')
                                        <div>
                                            ...
                                            <div class="mb-3 mt-3">
                                                ...
                                                <input type="text" class="form-control" name="column" placeholder="Enter column title" wire:model="values.one-column-info-page.column_title">
                                            </div>
                                            <div class="mb-3 mt-3">
                                    ...
                                    @elseif($info_page_template_component_name == 'two-column-info-page')
                                        <div>
                                            ...
                                            <div class="mb-3 mt-3">
                                                <label for="column1" class="form-label">Second Column Text</label>
